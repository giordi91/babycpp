...
BabycppJIT::BabycppJIT() {
  ...
  compileLayer = new llvm::orc::IRCompileLayer <llvm::orc::RTDyldObjectLinkingLayer, llvm::orc::SimpleCompiler>(*objectLayer, llvm::orc::SimpleCompiler(*tm));
...
// created SectionMemoryManager, this step will triggle compilation right
//away, meaning it wont be lazy
return llvm::cantFail(compileLayer->addModule(m,
                                     std::move(Resolver)));
}
